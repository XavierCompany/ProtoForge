...
>
> The full step-by-step tutorial (8 steps, with Azure AI Foundry LLM wiring
> example) lives in BUILDING_AGENTS.md. It covers both the **Forge method**
> (YAML-only, no Python) and the **Code method** (custom Python class).
>
> What follows below is only the skills & workflows reference that
> complements the agent-building tutorial.
