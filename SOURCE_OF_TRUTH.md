...
| HTTP request/response contracts | `src/server_models.py` | ✓ Canonical for FastAPI body schemas |
| HTTP route logic | `src/server_routes/*.py` | ✓ Canonical route implementations |
| HTTP app composition | `src/server.py` | ✓ Canonical wiring (`create_app`, CORS/auth setup) |
